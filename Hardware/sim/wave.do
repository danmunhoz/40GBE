...
WaveRestoreCursors {{falta blobo 07 no PCS0} {2038400 ps} 1} {{pkt 42 codificado em erro} {10550400 ps} 1} {{entrada em data_in (pkt_id=43)} {3024000 ps} 1} {{Cursor 4} {7232300 ps} 0}
...
update
WaveRestoreZoom {7215021 ps} {7249579 ps}
