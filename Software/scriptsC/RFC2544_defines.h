...
#define LFSR_SEED_95_64_REG   	0x8C
#define LFSR_SEED_127_96_REG  	0x90
#define LFSR_SEED_159_128_REG 	0x94
#define LFSR_SEED_191_160_REG 	0x9C
#define LFSR_SEED_223_192_REG 	0xA0
#define LFSR_SEED_255_224_REG 	0xA4
#define LFSR_POLYNOMIAL_REG 	0xA8

#define CYCLES_REG 				0xAC
#define LAST_BITS_REG 			0xB0

#define LOOPBACK_FILTER_REG 	0xB4
#define START_RESET_TEST 		0xB8
#define PACKETS_LOST_31_0_REG 	0xBC
#define PACKETS_LOST_63_32_REG 	0xC0
//#define LAST_ID 0xA8
